...
public class WorkerBean1 {
    ...
    public Future<String> doWork(String what) {
        // Do some work...
        try {
            Logger.getLogger(WorkerBean1.class.getName()).log(Level.INFO, "Worker1 working ...");
            Thread.sleep((int) (Math.random() * 2000)); // 0 <= value < 2000
            Logger.getLogger(WorkerBean1.class.getName()).log(Level.INFO, "Worker1 done.");
        } catch (InterruptedException ex) {
            Logger.getLogger(WorkerBean1.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        return new AsyncResult<>("Worker1 for '" + what + "'");
    }
}
