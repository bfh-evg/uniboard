...
public class SectionedComponent extends Component {
	...
	private static final Logger logger = Logger.getLogger(SectionedComponent.class.getName());
	...
	protected void beforeGet(Query query) {
		super.beforeGet(query); //To change body of generated methods, choose Tools | Templates.
	}
