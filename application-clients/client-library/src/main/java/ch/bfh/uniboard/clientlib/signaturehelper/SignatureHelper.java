...
public abstract class SignatureHelper {
	...
	return sign(messageElement).getBigInteger();
    }
    ...
    /**
     * Helper method creating an UniCrypt element with the message and the alpha and beta attributes. This method must be
     * called when verifying board signature after post
     *
     * @param message message to include in element
     ...
     * @return the element representing the message and alpha and beta attributes (Board signature and following attributes
     * excluded)
     */
    ...
    /**
     * Helper method creating an UniCrypt element with the message and the alpha and beta attributes, stopping before attribute
     * with name passed in "lastAttributeName" is met in beta attributes. This is the method that is called when verifiying board
     * signature after post (lastNameSignature must contain UniBoardAttributesName.SIGNATURE) and when verifying board signature
     * in posts returned in a result container (lastNameSignature must be null)
     * @param message message posted
     * @param alpha alpha attributes to include in element (all attributes are included)
